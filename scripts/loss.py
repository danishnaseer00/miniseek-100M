...
# Aligned token counts (WikiText-103 across 5 epochs)
...
# Training losses
# Note: Since epochs 1-4 for 17.7M were None in the initial log, an estimated 
# trajectory is provided here leading up to the logged final value (3.6944).
# Replace the first 4 values below if you retrieve the exact per-epoch step values.
...
# Palette
c_17 = '#0072B2'        # Color-blind safe blue
c_101 = '#E69F00'       # Color-blind safe amber
c_train_17 = '#6E7781'  # Neutral slate (open circle marker)
c_train_101 = '#424A53' # Deep slate (solid triangle marker)

# 1. Validation Curves (Solid lines)
...
# 2. Training Curves (Dashed lines)
...
# 3. Dedicated Offsets for Final Value Labels (Ensures 0 Overlap)
# 17.7M Train (3.69) - Shifted slightly up
...
# 17.7M Val (3.66) - Shifted slightly down
...
# 101.4M Val (3.17) - Shifted slightly up
...
# 101.4M Train (2.96) - Shifted slightly down
